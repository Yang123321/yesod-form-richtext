...
snHtmlFieldCustomized :: (Monad m,YesodSummernote (HandlerSite m))=>
                         String
                      -> Field m Html
...
snHtmlField :: (Monad m,YesodSummernote (HandlerSite m))=>
               Field m Html
